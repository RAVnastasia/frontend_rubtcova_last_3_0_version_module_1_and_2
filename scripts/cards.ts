// Интерфейс для данных карточки проекта
...
class ApiCardsManager {
  ...
  public async loadCards(limit: number = 3): Promise<ApiPost[]> {
    try {
  ...
  private createApiCard(post: ApiPost): string {
    return `
      <div class="api-card">
...
export { ProjectCardsManager, ApiCardsManager, ProjectCard, ApiPost };
