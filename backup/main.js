...
(function() {
  ...
  if (heroVideoElement) {
    ...
    heroVideoElement.setAttribute('loop', '');
    ...
    heroVideoElement.addEventListener('error', (e) => {
      ...
      // You could hide the video and show a fallback image here
    });
  }
